...
const HeroSection = ({ personal, contact, socials, copy }: HeroSectionProps) => {
  ...
  return (
    <section
      id="inicio"
      className="relative overflow-hidden rounded-3xl border border-neutral-300 bg-white px-6 py-12 shadow-soft dark:border-slate-700 dark:bg-surface md:px-12 md:py-16"
    >
      ...
      <div className="grid gap-12 md:grid-cols-[1.3fr_minmax(0,0.7fr)] md:items-center">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="font-display text-4xl font-semibold tracking-tight text-neutral-900 dark:text-white md:text-5xl">
              {personal.name}
            </h1>
            <p className="text-base text-slate-600 dark:text-slate-300">{personal.summary}</p>
          </div>
