...
const AchievementsSection = ({ achievements, copy }: AchievementsSectionProps) => {
  return (
    <section id="logros" className="space-y-8">
      <SectionHeader
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {achievements.map((achievement) => (
          <article
            ...
            className="flex flex-col gap-4 rounded-2xl border border-neutral-300 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:border-primary-light hover:shadow-glow dark:border-slate-700 dark:bg-surface"
          >
            <div>
